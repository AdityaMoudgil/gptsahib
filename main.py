...
load_dotenv()
openai.api_key = os.environ.get('OPENAI_API_KEY', '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')

persist_directory = 'a1i'   
embeddings = OpenAIEmbeddings(openai_api_key='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')


if not os.path.exists(persist_directory):
    print('embedding the document now')
    loader = UnstructuredPDFLoader('/a1i/a1.pdf', mode="elements")
